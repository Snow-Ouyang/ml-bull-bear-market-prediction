...
![Equity curve comparison](docs/images/equity-curve-comparison-v2.png?cache=20260708)
...
![Jump Model state CAGR by split](docs/images/jump-cagr-v2.png?cache=20260708)

![Jump Model state annualized volatility by split](docs/images/jump-volatility-v2.png?cache=20260708)
...
![Final model vs buy-and-hold with bear shading](docs/images/final-model-vs-buyhold-bear-shading-v2.png?cache=20260708)
...
![Final model OOS confusion matrix](docs/images/oos-confusion-matrix-v2.png?cache=20260708)
...
![Final model OOS ROC curve](docs/images/oos-roc-curve-v2.png?cache=20260708)
...
![Final model OOS classification metrics over time](docs/images/oos-metrics-over-time-v2.png?cache=20260708)
